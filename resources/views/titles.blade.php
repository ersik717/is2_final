...
<button type="button" class="hamburger is-closed" data-toggle="offcanvas">
  ...
  <a class="btn btn-danger" style="margin-left: 84%; margin-top: 100px;" href="charts"><-previous</a>          
<div class="container">
<div class="panel-heading">
                    <h3>Number of Employees By Titles</h3>
                </div>

<canvas id="myChart" width="400" height="150"></canvas>
<script>
    var url = "{{url('charter2')}}";
...
<a class="btn btn-success" style="margin-left: 85%; margin-bottom: 5%;" href="salaries">next-></a>
