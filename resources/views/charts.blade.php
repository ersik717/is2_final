...
<div class="panel-heading">
                    <h3>Number of Employees in Separate Departments</h3>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        albdata.push(response.total);
        alblabels.push(response.name);
        color.push('rgba('
...
<a class="btn btn-success" style="margin-left: 85%; margin-bottom: 5%;" href="titles">next-></a>
